...
RLAPI void DrawLineGrad(Vector2 startPos, Vector2 endPos, Color startColor, Color endColor);             // Draw a line with gradient
...
RLAPI void SetMaterialShader(Material *material, Shader shader);                            // Set shader for a material
